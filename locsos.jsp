                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h2 class="text-uppercase text-primary mb-1">AMIGO-ASSIST</h2><br><br>
                            <h2 class="text-uppercase text-primary mb-1">select location of emergency service</h2><br><br>
               <form id="f1"  method="post" action="emg.jsp">
                      Location:   
